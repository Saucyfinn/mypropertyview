...
class AppState: ObservableObject {
    ...
    func updateCoordinates(_ coordinates: ARCoordinateData) {
        print("📍 AppState.updateCoordinates called: \(coordinates.subjectProperty.appellation) with \(coordinates.subjectProperty.arPoints.count) points")
        DispatchQueue.main.async {
            ...
            print("✅ AppState coordinates updated successfully")
        }
    }
